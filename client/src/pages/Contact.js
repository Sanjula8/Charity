...
import ContactNav from "../components/ContactNav/index";
import "./contact.css";
							...
							>
								<div className="section-title">
									...
									<p>
										...
										adipiscing morbi venenatis et tortor
										consectetur adipisicing lacinia tortor
										morbi ultricies.
									</p>
								</div>

								<p>
									<i className="fa fa-map-marker"></i> 456 New
									Street 22000, New York City, USA
								</p>
								<p>
